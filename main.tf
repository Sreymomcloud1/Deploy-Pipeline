...
# 1. Key pair using your existing local file reference
...
# 4. Security Group for EC2 (Matches your logic)
...
# 5. Launch Template (SONARCLOUD FIX APPLIED)
resource "aws_launch_template" "app_lt" {
  ...
  network_interfaces {
    ...
    # CHANGED TO FALSE: This resolves the security hotspot in image_fe327d.png
